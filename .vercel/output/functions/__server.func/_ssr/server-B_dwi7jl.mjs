...
import { H as H3Event, t as toResponse, p as parseCookies, s as setCookie$1, d as deleteCookie$1 } from "../_libs/h3-v2.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BTDwJdaw.mjs");
...
const manifest = {
  "071d3e76962d8aedf14b7eb3f9f693aab823595f9fa1e3d6ee4d3851fdc03db7": {
    functionName: "createProduct_createServerFn_handler",
    importer: () => import("./products-BMlepdCz.mjs")
  },
  "11ffe802f5af92bfed3d445ee0a98cb14219057789c6f32cdc9d8b4c6eaae244": {
    functionName: "updateBlogPost_createServerFn_handler",
    importer: () => import("./blog-DeA1BsdP.mjs")
  },
  "21872e4dddb99457312fbaece1519ad9f57221a1a4a98bed2dd03c0863b5158f": {
    functionName: "updatePackage_createServerFn_handler",
    importer: () => import("./packages-goBZh-ib.mjs")
  },
  "42b7eecb730fa01dbdb05dc58e38f4adf995ebed3b73a53cd065b0569701cc40": {
    functionName: "deleteProduct_createServerFn_handler",
    importer: () => import("./products-BMlepdCz.mjs")
  },
  "455206e1791f6139b8136440be00febf739d24ed6527be903a0af6c5c12f21fa": {
    functionName: "submitThought_createServerFn_handler",
    importer: () => import("./blog-DeA1BsdP.mjs")
  },
  "4b16bf50c41c177dc6b01f4f6070e4c11c9d088cf876207a74711f3500a11379": {
    functionName: "uploadMedia_createServerFn_handler",
    importer: () => import("./media-D0U_cG9F.mjs")
  },
  "639d3178a4937bc6a9aec740300a040b784280e56d955e4c86209c703e70b374": {
    functionName: "sendContact_createServerFn_handler",
    importer: () => import("./contact-CnKdOZ5y.mjs")
  },
  "6a12fc89b15863ec6f1317fa3e62e4d2290bef5a61b105ca7c5fac151daf8165": {
    functionName: "listBlogPosts_createServerFn_handler",
    importer: () => import("./blog-DeA1BsdP.mjs")
  },
  "748bd546fd025e0fc09ef9595f3919e919fae6ad268e6fd048d71de69914bd90": {
    functionName: "listPackages_createServerFn_handler",
    importer: () => import("./packages-goBZh-ib.mjs")
  },
  "8839b6579fea2382624c13f25a4f6a04ce4a14e06bd29a5b067d7d1c4f3787bd": {
    functionName: "adminLogout_createServerFn_handler",
    importer: () => import("./admin-Cwx-hNsb.mjs")
  },
  "8c043fe5e33ca88dc069e5f365006f24e7f14e8a80a334f08652dec76c740e7b": {
    functionName: "listProducts_createServerFn_handler",
    importer: () => import("./products-BMlepdCz.mjs")
  },
  "917d7db902f6c80f5a6dc5299f3a7bb1ddb02d1963bb2bb0b02fff73781402a8": {
    functionName: "listTags_createServerFn_handler",
    importer: () => import("./tags-Ck3hwjYx.mjs")
  },
  "a967cf0b9fd1d1c3b67a41ef7e9441d684ddc7a64ffd27d95ab762a10be7e19b": {
    functionName: "createPackage_createServerFn_handler",
    importer: () => import("./packages-goBZh-ib.mjs")
  },
  "ad8a26a11564ff86f4299d5236d4f1f8fb271512df6fb5f99e918cadeea0cb2d": {
    functionName: "createBlogPost_createServerFn_handler",
    importer: () => import("./blog-DeA1BsdP.mjs")
  },
  "b6c3943f205d8f5cb5155be038e8f306adc8d93e7022f9abd3cf100628b790fd": {
    functionName: "deleteBlogPost_createServerFn_handler",
    importer: () => import("./blog-DeA1BsdP.mjs")
  },
  "ca6a66f5993f478d418e1fd06079a4f3ed41b30a0881e47e397b6a7e9dfb6736": {
    functionName: "getAdminSession_createServerFn_handler",
    importer: () => import("./admin-Cwx-hNsb.mjs")
  },
  "def553391d103ab7116e46092712ab02fee005b9091b8c5875162aeee4ab7be6": {
    functionName: "adminLogin_createServerFn_handler",
    importer: () => import("./admin-Cwx-hNsb.mjs")
  },
  "e22697e5f465077d541e7fa0749c003deaa7fa44785500b79727465c2f768c76": {
    functionName: "deletePackage_createServerFn_handler",
    importer: () => import("./packages-goBZh-ib.mjs")
  },
  "e3b5eb71359407d6d88ad1269ba5879332bc9ed446121bbf220a296f86f30b5f": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CyM4s3oU.mjs"),
    import("./start-BFHqUCWq.mjs"),
