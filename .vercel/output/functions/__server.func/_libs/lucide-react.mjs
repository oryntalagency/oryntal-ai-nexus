...
const AppWindow = createLucideIcon("app-window", __iconNode$_);
const __iconNode$Z = [
...
const Bookmark = createLucideIcon("bookmark", __iconNode$V);
const __iconNode$U = [
...
const Images = createLucideIcon("images", __iconNode$B);
const __iconNode$A = [
