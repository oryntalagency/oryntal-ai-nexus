...
import { b as NodeResponse, t as toNodeHandler } from "./_libs/srvx.mjs";
...
const _lazy_y25zYq = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_y25zYq };
  return ((_m, p) => {
